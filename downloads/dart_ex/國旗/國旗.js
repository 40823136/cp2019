...
(function dartProgram() {
  ...
  B = {
    main: function() {
      ...
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new B.main_closure(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#ROC"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new B.main_closure0(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = J.get$onClick$x(t1.querySelector("#button"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new B.main_closure1(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#FR"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new B.main_closure2(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = J.get$onClick$x(t1.querySelector("#TP"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new B.main_closure3(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#PR"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new B.main_closure4(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t1 = J.get$onClick$x(t1.querySelector("#GE"));
      t2 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new B.main_closure5(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    drawJP: function(ctx) {
      var _s4_ = "#fff";
  ...
  B.main_closure0.prototype = {
    call$1: function(e) {
      H.interceptedTypeCheck(e, "$isMouseEvent");
      return B.drawROC($.ctx);
    },
    $signature: 1
  };
  B.main_closure1.prototype = {
    call$1: function(e) {
      H.interceptedTypeCheck(e, "$isMouseEvent");
      $.ctx.clearRect(0, 0, 300, 200);
      return;
...
//# sourceMappingURL=%E5%9C%8B%E6%97%97.js.map
